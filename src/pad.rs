...
//!
//! The triggers are the exception, and only because zooming is the exception.
...
//! Zoom is the one control here that genuinely wants the analogue: a stop
//! ladder is right for a button and wrong for a thumb resting on a trigger.
//!
...
///
/// A resting thumb and a worn spring both sit a little off nought, and a
/// picture that crept towards the viewer whenever nobody was touching it would
/// be the most annoying possible bug.
const DEAD: f32 = 0.12;
