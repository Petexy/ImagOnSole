{
  ...
  libGL,
  vulkan-loader,
  # What the interface sounds go out through. Linked outright rather than
  # opened by name, so this is the one in the list that the usual RPATH
...
rustPlatform.buildRustPackage {
  ...
  installPhase = ''
    ...
    install -Dm0644 LICENSE "$out/share/licenses/imagonsole/LICENSE"
    install -Dm0644 README.md "$out/share/doc/imagonsole/README.md"

    runHook postInstall
  '';

  postFixup = ''
    wrapProgram "$out/bin/imagonsole" \
  ...
  meta = {
    ...
    homepage = "https://github.com/Petexy/imagonsole";
    license = lib.licenses.gpl3Only;
    platforms = lib.platforms.linux;
    mainProgram = "imagonsole";
  };
}
